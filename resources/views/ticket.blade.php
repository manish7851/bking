...
<body>
    <div class="ticket">       
            ...
            <h1 style="text-align: center;">AMBIKASWORI YATAYAT</h1>
            <h2 style="text-align: center;">Bus Ticket</h2>
        </div>
        <div class="ticket-details">
            <p><strong>Booking ID:</strong> {{ $booking->id }}</p>
            <p><strong>Bus Name:</strong> {{ $booking->bus_name }}</p>
            <p><strong>Bus Number:</strong> {{ $booking->bus_number }}</p>            <p><strong>Route:</strong> {{ $booking->source }} - {{ $booking->destination }}</p>
